            ...
            <ul class="container nav navbar-nav justify-content-end">
                <li class="nav-item">
                    <a class="nav-link nav-menu" href="/" title="Retour au menu"><span class="container mr-1"><i
                                class="fa-solid fa-left-long fa-lg"></i></span>Retour au menu</a>
                </li>
            </ul>
        </div>
    </div>
...
<div class="container-fluid row align-items-start">
                    ...
                    <div class="col-11">
                        <div class="container row">
                            <div class="col-4 cart-detail-image">
                                <img src="/public/uploads/uramaki_thon.jpg" alt="Image de l'article"
                                    class="cart-detail-image">
                            </div>
                            <div class="col-7 mt-4" cart-detail-text>
                                <h4>Urumaki au thon</h4>
                                <p>Thon et crème sure entourés d'une feuille d'algue et de riz vinaigré ainsi que de
    ...
    <div class="col-4"> <!-- Passer à la caisse -->
        <div class="row admin">
            ...
            <a href="/checkout" id="cart-proceed-to-checkout" class="btn cart-proceed-to-checkout">Passer à la
                caisse</a>
        </div>
    </div>
</div>
